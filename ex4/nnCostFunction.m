...
%% Part 0: Formatting y for training

% Making y a binary 10 Column Matrix y - R^{5000x1} --> Y R^{5000x10}
...
sigma_3 = a_3-Y;
sigma_2 = sigma_3*Theta2 .* [ones(size(z_2,1),1), sigmoidGradient(z_2)];
sigma_2(:,1) = [];
...
%% Part 3: Regularization w/ cost Function & Gradients
